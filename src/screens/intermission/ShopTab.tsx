...
export default function ShopTab() {
  ...
  return (
    <div className="col" style={{ marginTop: 4 }}>
        ...
        <div className="row" style={{ gap: 6 }}>
          ...
          <button
            ...
            onClick={() => {
              ...
              setRefreshing(true);
              setFxBusyWaves('正在搬出装备，请稍等', '已完成补货');       // 两段波：遮罩 + 锁全局交互（防连点刷新）
              refreshShop();                         // 立即发请求（云端后台 / 本地即时）
              setTimeout(() => { setRefreshing(false); setFxBusy(null); }, 1250); // 响应上限 1.25s
            }}
      ...
      {buyF.controls}
      <div className="card-grid" id="tut-shop-buy-grid">
        ...
        {shopStock.consumables.map((c) => {
          ...
          return (
            <div className="card" key={c.id} style={{ borderColor: cfg.color }}>
