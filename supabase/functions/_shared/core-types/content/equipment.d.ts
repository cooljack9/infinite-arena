import { Rarity, AffixKey, Affix, AffixMode, Equipment, Chest, ChestReward, ConsumableItem } from '../types.d.ts';
...
/** 开一个箱：按掉落表决定是装备还是金钱 */
export declare function rollChest(rng: RNG, layer: number): Chest;
/** 一场战斗的全部掉落箱 */
export declare function rollDrops(rng: RNG, layer: number, boss: boolean): Chest[];
