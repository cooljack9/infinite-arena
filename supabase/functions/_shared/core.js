...
var BattleSim = class {
  ...
  killIfDown(u, killer) {
    ...
    this.emitAudio({ id: u.side === "ally" ? "death_ally" : "death_enemy", x: u.x, arenaW: this.W, victim: u.name, killer: killer?.name });
...
var CORE_BUILD_HASH = "91491077bbeda11c44ccdafd5a07bb94aaa29f649ed421e1129364b9930dbcc2";
export {
