 ...
 */
export const CHEST_TABLE_HIGH: { reward: ChestReward; p: number }[] = [
  { reward: 'equip_normal', p: 0.40 * (10 / 14) },
  { reward: 'gold_small',   p: 0.20 * (10 / 14) },
  { reward: 'equip_high',   p: 0.25 },
  { reward: 'equip_rare',   p: 0.15 },
  { reward: 'gold_large',   p: 0.10 * (10 / 14) },
];
...
function rollChestReward(rng: RNG, highBonus = false): ChestReward {
...
export function rollChest(rng: RNG, layer: number, highBonus = false): Chest {
...
export function rollDrops(rng: RNG, layer: number, boss: boolean, highBonus = false): Chest[] {
