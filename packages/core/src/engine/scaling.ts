...
// v2.2 新手模式封顶：打通即「通关」并解锁无尽模式，且封顶前穿插弹窗教学。
// v2.10：由 5 → 10 层。原因：① 用户反馈 5 层不足以讲完全部机制；
//   ② 真空期/突变层仅在 n%10===0 触发，唯延长到 10 层才能在封顶层现场演示这两机制，
//   否则新手永远见不到。敌人缩放走平滑亚线性曲线，6~10 层数值温和，确定性不受影响。
export const NOVICE_CAP = 10;
